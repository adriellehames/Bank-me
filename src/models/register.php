...
$request_date,$status_register,$user_complience_approve){
    ...
    $this->db= new Database(); //estabelece a instância de conexão
 ...
 private function insert_db(){// estou usando o "executequery" do  Database.php
    $query=("INSERT INTO register (id, name, surname, cpf, rg, birth_date, postal_code,state,city,district,adress, number,complement,monthly_income,profession,telephone, document_photo,email,request_date,status_register,user_complience_approve ) VALUES (:id, :name, :surname, :cpf, :rg, :birth_date, :postal_code,:state,:city,:district,:adress, :number,:complement,:monthly_income,:profession,:telephone, :document_photo,:email,:request_date,:status_register,:user_complience_approve");
    $params= [
    ':id'=> $this->id,
    ':name'=> $this->name,
    ...
    ':user_complience_approve'=> $this->user_complience_approve
];
